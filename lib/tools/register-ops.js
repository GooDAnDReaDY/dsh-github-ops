...
export function registerOpsTools({ tool, asRepo, client, liveConfig }) {
  ...
  tool(
    ...
    repoParams({
      ...
      conditions: { type: 'object', description: 'Ruleset conditions, e.g. { ref_name: { include: ["refs/heads/main"], exclude: [] } }.' },
      rules: { type: 'array', items: { type: 'object' }, description: 'Ruleset rules, e.g. [{ type: "deletion" }].' },
    }),
