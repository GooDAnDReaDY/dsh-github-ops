  ...
  factory: (require) => {
    ...
    function ensureCss() {
      ...
      style.textContent = [
        ...
        '.gho-status-bad{color:var(--dsw-alias-label-error)}',
        ...
        '.gho-scm-btn-warn{border-color:var(--dsw-alias-label-error);color:var(--dsw-alias-label-error)}',
        ...
        '.gho-scm-error{color:var(--dsw-alias-label-error)}',
